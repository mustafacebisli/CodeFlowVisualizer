...
public class ProjectExplorerPanel extends JPanel {
    ...
    public ProjectExplorerPanel() {
        ...
        header.setBackground(new Color(37, 37, 40));
        ...
        tree.setBackground(new Color(30, 30, 33));
        tree.setForeground(new Color(212, 212, 212));
        tree.getSelectionModel().setSelectionMode(TreeSelectionModel.SINGLE_TREE_SELECTION);
        tree.setRowHeight(22);
        tree.setFont(new Font(Font.MONOSPACED, Font.PLAIN, 11));
        tree.setCellRenderer(new DefaultTreeCellRenderer() {
            ...
            public Component getTreeCellRendererComponent(JTree tree, Object value, boolean sel, boolean expanded,
                ...
                c.setBackground(sel ? new Color(38, 79, 120) : new Color(30, 30, 33));
                c.setOpaque(true);
                c.setForeground(new Color(212, 212, 212));
